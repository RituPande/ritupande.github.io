...
Historically, the groups were not separate from their representations. However, in the late nineteenth century Cayley abstracted a group from its transformation representations. Representation theory aims to understand different ways in which abstract groups can be realized as set of transformations.
